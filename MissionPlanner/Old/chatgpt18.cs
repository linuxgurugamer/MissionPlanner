...
//
// This version:
// - Adds runtime sliders to tune column widths (Title Width % and Controls Pad), persisted in UI.cfg
// - Removes "Edit…" buttons (double-click title to open details)
// - Save/Load/Hide at bottom; drag-from-anywhere (DragWindow at end of window draws)
...
namespace MissionPlanner
{
    ...
    public class HierarchicalStepsWindow : MonoBehaviour
    {
        ...
        private float _controlsPad = 40f;     // 0..120 px extra right padding for controls
