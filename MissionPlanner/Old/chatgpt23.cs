...
namespace MissionPlanner
{
    ...
    public class HierarchicalStepsWindow : MonoBehaviour
    {
        ...
        private Rect _saveAsRect = new Rect(740, 200, 440, 170);
        ...
        public void OnGUI()
        {
            ...
            if (_showSaveAs)
            {
                _saveAsRect = GUILayout.Window(
                    ...
                    "Save As…",
                    GUILayout.MinWidth(380), GUILayout.MinHeight(140)
                );
            }
        }
        ...
        private void DrawTreeWindow(int id)
        {
            ...
            // --- Bottom bar: Save / Save As… / Load / Hide + Save indicator ---
            GUILayout.Space(6);
            GUILayout.BeginHorizontal();

            if (GUILayout.Button("Save", GUILayout.Width(90))) { TrySaveToDisk_Internal(true); }

            if (GUILayout.Button("Save As…", GUILayout.Width(100))) { OpenSaveAsDialog(); }
        ...
        private void DrawSaveAsDialogWindow(int id)
        {
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Label("New mission name:", GUILayout.Width(140));
