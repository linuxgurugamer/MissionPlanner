...
//
// New in this version:
// - Persist _useKspSkin and all window positions across sessions (UI.cfg)
// - EnsureStyles() updated per your snippet (rebuilds styles when skin changes)
// - GUI.DragWindow moved to the END of each window draw method
//
// Save path (missions): GameData/MissionPlanner/PluginData/<SaveName>__<MissionName>.cfg
// Save path (UI):       GameData/MissionPlanner/PluginData/UI.cfg
...
namespace MissionPlanner
{
    ...
    public class HierarchicalStepsWindow : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            // Load UI settings (skin + window rects)
            LoadUISettings();
        ...
        {
            // Auto-save mission on teardown (no overwrite dialog)
        ...
        public void OnGUI()
        {
            // Guard: do not draw while paused
        ...
        // Public entry: runs overwrite detection dialog when needed
