...
namespace MissionPlanner
{
    ...
    public class HierarchicalStepsWindow : MonoBehaviour
    {
        ...
        private void DrawTreeWindow(int id)
        {
            ...
            GUI.enabled = false;
            _summaryScroll = GUILayout.BeginScrollView(_summaryScroll, HighLogic.Skin.textArea, GUILayout.MinHeight(60), GUILayout.MaxHeight(90));
            GUILayout.TextArea(string.IsNullOrEmpty(_missionSummary) ? "(no summary)" : _missionSummary);
