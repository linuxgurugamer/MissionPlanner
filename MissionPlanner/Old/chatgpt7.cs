...
namespace MissionPlanner
{
    ...
    // KSP1 (Unity IMGUI) – recursive tree with reliable drag & drop (hotControl + topmost ghost),
    ...
    public class RecursiveCollapsibleList : MonoBehaviour
    {
        ...
        private const float DragThresholdSqr = 6f * 6f; // ~6px movement to start drag
        private Vector2 _mouseDownPos;  // where the mouse went down on the label
        ...
        private void HandleRowMouse(Node node, Rect rowRect, Rect labelRect)
        {
            ...
            switch (e.rawType)
            {
                case EventType.MouseDown:
                    // Only the LABEL starts capture/drag; prevents ± / ⊕ from initiating drags
        ...
        // Drag visuals drawn *above* all windows
